...
then
    ...
    echo " 6. RM3 - QueryMix:";
    echo " 7. Field to be used for Search. 1.Full, 2.Clean";
    echo " 8. Field to be used for Feedback. 1.Full, 2.Clean";
    echo " 9. Similarity Function: 1:BM25, 2: LM-JM, 3: LM-Dir";
    echo "10. [Rerank]? - Yes-1  No-0 (default)"
    exit 1;
fi

prop_name="rblm.D-"$4".T-"$5".S-"$7".F-"$8".properties"
#echo $prop_name
...
java -Xmx1g -cp $CLASSPATH:dist/WebData.jar:./lib/* RelevanceFeedback.RelevanceBasedLanguageModel $prop_name
